...
<head>
    ...
    <title>REGISTRY | Almost Harrisons</title>
  ...
  <?php include_once("header.php"); ?>
    ...
    <div class="grid-container">
        ...
        <div class="grid-80 push-10">
            <p>Although your presence is more than enough, we do appreciate presents that accompany your presence! All donations and gifts will go toward the <em>Josh & Jas Better Life Foundation</em>. If you don't already have your heart set on something, here are a few places that have things we've had our eye on. Click the store logo to browse our registry on their site.</p>
        </div>
    </div>
    <br/>
    <div class="grid-container">
